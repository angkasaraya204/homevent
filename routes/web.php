...
Route::get('/kategori/{id}', [TamuController::class, 'showByKategori'])->name('artikel.kategori');
Route::get('/artikel/{id}', [TamuController::class, 'detailArtikel'])->name('artikel.detail');
