...
<section class="section">
    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('tamu.acara.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('link') is-invalid @enderror" name="link" placeholder="Masukan Link Kredensial" value="{{ old('link') }}">
                            @error('link')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('tempat') is-invalid @enderror" name="tempat" placeholder="Masukan Tempat Acara" value="{{ old('tempat') }}">
                            @error('tempat')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
