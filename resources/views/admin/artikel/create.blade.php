                    ...
                    <div class="card-body">
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" placeholder="Masukan Judul" value="{{ old('judul') }}">
                            </div>
                            @error('judul')
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control @error('slug') is-invalid @enderror" name="slug" placeholder="contoh tutorial-masak" value="{{ old('slug') }}">
                            </div>
                            @error('slug')
                            <div class="invalid-feedback">
                                {{ $message }}
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control @error('penulis') is-invalid @enderror" name="penulis" placeholder="Masukan Penulis" value="{{ old('penulis') }}">
                            </div>
                            @error('penulis')
                            <div class="invalid-feedback">
                                {{ $message }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <textarea class="summernote-simple @error('konten') is-invalid @enderror" name="konten">{{ old('konten') }}</textarea>
                            </div>
                            @error('konten')
                            <div class="invalid-feedback">
                                {{ $message }}
